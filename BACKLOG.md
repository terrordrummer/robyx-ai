...
- Files likely touched:
  - [bot/reminders.py](bot/reminders.py)
  - [bot/messaging/base.py](bot/messaging/base.py)
  - platform adapters under [bot/messaging/](bot/messaging)
- Acceptance criteria:
...
- Files likely touched:
  - [bot/scheduler.py](bot/scheduler.py)
  - [bot/timed_scheduler.py](bot/timed_scheduler.py)
  - [bot/handlers.py](bot/handlers.py)
  - [bot/ai_invoke.py](bot/ai_invoke.py)
- Acceptance criteria:
...
- Files likely touched:
  ...
  - [tests/test_bot.py](tests/test_bot.py)
  - [tests/test_scheduler.py](tests/test_scheduler.py)
  - [tests/test_timed_scheduler.py](tests/test_timed_scheduler.py)
